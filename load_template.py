...
DATA_FILE_PATH = "/Users/sanjeevd/documents/introtodb/fproj/usage.tsv"
...
with open(DATA_FILE_PATH) as file:
	...
	correct = ['station', 'date', 'awnd', 'snwd', 'tavg']
	print header
	for line in file:
		attrs = {att: val for att, val in zip(header, line.rstrip().split('\t')) if att in header}
